import {startQuiz} from "../components/quizView.js"
function renderAllQuizView(data) {
    const container = document.createElement("div");
    container.className = "quiz-container";

  // --- Barre de recherche sticky et stylée ---
...
title.textContent = "Liste des quiz : ";
title.style = `
  margin: 0;
  font-size: 2rem;
  font-weight: 600;
...
searchBarWrapper.appendChild(title);
...
export function renderQuizDashboard() {
   ...
   quizListContainer.classList.add("fade-in"); // Appliquer l'effet
main.appendChild(quizListContainer);
 renderAllQuizView(allData);
// Forcer une reflow avant d'ajouter la classe 'show'
setTimeout(()=>{
requestAnimationFrame(() => {
  quizListContainer.classList.add("show");
});
  },500) 
}